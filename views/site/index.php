...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
	<div class="container">
		<div class="row">
			<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/template/images/bg_2.jpg);">
		...
		<div class="row">
			...
			<?php foreach ($products as $item) : ?>
				<div class="col-sm col-md-6 col-lg ftco-animate">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid" src="/template/images/<?= $item['image'] ?>" alt="Picture"></a>
...
<section class="ftco-section ftco-section-more img" style="background-image: url(/template/images/bg_5.jpg);">
	<div class="container">
		<div class="row justify-content-center mb-3 pb-3">
